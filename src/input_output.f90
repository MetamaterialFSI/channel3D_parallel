...
Contains
  ...
  Subroutine create_grid
    ...
    Select Case (grid_type)
      ...
      Case (2) ! Stretched grid centered around 0 with uniform buffers on each end to account for IB (moving with amplitude body_param_1)
        ...
        Do
          Call create_stretched_main_grid(y_global, Ly_channel, ny_global, n_uniform, alpha_stretch)
  ...
  Subroutine create_stretched_main_grid(grid, L, n_total, n_uniform, alpha)
    Implicit None
  ...
  End Subroutine create_stretched_main_grid
